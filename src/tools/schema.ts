          ...
          scenes: {
            ...
            items: {
              ...
              properties: {
                ...
                readerQuestion: { type: "string", description: "本场结束时读者最想知道什么；本场内不给答案，各场不得重复" },
                cost: { type: "string", description: "谁付出了不可撤销的代价；整章至少一场必填" },
                oppositionMove: { type: "string", description: "阻力方本场主动做了什么，而非只是挡着" },
              ...
              required: ["id", "goal", "obstacle", "turn", "outcome", "readerQuestion"],
              additionalProperties: false,
            },
          },
        },
          ...
          remainingScenes: {
            ...
            items: {
              ...
              properties: {
                ...
                readerQuestion: { type: "string", description: "本场结束时读者最想知道什么；不得与任何已完成场景重复" },
                cost: { type: "string", description: "谁付出了不可撤销的代价；整章至少一场必填" },
                oppositionMove: { type: "string", description: "阻力方本场主动做了什么，而非只是挡着" },

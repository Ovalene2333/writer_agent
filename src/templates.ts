...
广场上十万只终端自行亮起。雪花噪点里，一个衰老的男声说：“小砾，潮水退了，别往礁石下面看。”

沈砾抬起头。

那是父亲哄她离开海边时才会说的话。父亲死了二十七年，从没登上过远征舰。

执刑官停住宣判。高台后的总督先看了一眼天空，才示意卫兵放下粒子枪。“你能回答它吗？”

“能。”沈砾说。

人群开始骚动。三个月前，她因为坚持太阳内部存在人工讯号被判煽动罪；现在同一批议员挤到栏杆前，仿佛最早相信她的人就是他们。

终端里的噪声忽然整齐起来。每隔七秒，一次脉冲。沈砾听了四轮，手腕在锁环里慢慢绷紧。
...
起初只有指甲大小的黑斑，随后越张越大。一艘船从恒星表面升起，船身没有反光，像有人从白昼里割下一片夜。它后方，一列更小的阴影依次浮现。

广场安静得只剩遮光阵列转动的低鸣。

沈砾数到第九艘时明白了讯号的意思。不是返航编号，是幸存者数量。

九艘船，九个人。

而帝国三百年前送出去的远征军有四十万。

总督亲手解开她的锁环，把一枚黑色译码针塞进她掌心。“让他们降落。你的罪，当场赦免。”

针尖已经亮了。只要刺入终端，她就能取得舰队的引导权。

沈砾却看见第九艘船正下方，太阳风被压出一道极细的弧线。有什么比舰队大得多的东西，仍藏在恒星里面，沿着它们打开的航道缓慢转身。

父亲的声音再次响起。

“别让我们回家。”

卫兵重新举枪。总督的手按住她肩膀，力道温和得近乎劝告。

沈砾握紧译码针，转身刺进了审判柱。

白塔广场的能源护盾轰然升起，不是迎接舰队，而是封锁整颗首都星。`,
    exampleNotes: "清晰商业叙事承载传奇尺度：私人暗语连接文明危机，赦免诱惑逼出主动选择；奇观改变行动条件，结尾是不可撤回的封锁而非空泛悬念。",
  },
  {
    id: "light-novel",
    name: "轻小说",

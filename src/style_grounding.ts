...
- 先找本场最有牵引力的动作、关系压力或发现，让其他材料围绕它自然进入。硬事实与明确须落地的信息必须成立；提纲、场景卡和写作材料不是逐项展开的段落模板，也不要求补齐感官、物件、对白或句长配额。
...
- 对白是人物在关系中采取的行动。直说、回避、沉默、玩笑或解释都可以，只要符合说话者的目的、知识与处境；人物差异首先来自各自在意和不愿承认的东西。说出口的直接对白可使用「……」、“……”或"……"，同章宜前后一致；对白内嵌引文可用『……』。

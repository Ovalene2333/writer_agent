...
- 对白要有摩擦与声线：别把交锋写成一问一答的确认流水——有人回避、答非所问、打断、说到一半停住，或答一件对方没问的事；每个常出场的人物有一处别人不会有的说话方式，遮住提示语能认出是谁。句长跟处境走，可以短，但别整章都是几个字的应答。终审设有 dialogue_frictionless 驳回项，voice_homogenization 的判罚门槛也已收紧。

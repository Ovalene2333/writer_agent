...
/** Immutable record of the request that produced a generated image attachment. */
export interface ImageGenerationMetadata {
  /** Exact prompt sent to the image provider after tool validation. */
  finalPrompt: string;
  /** Provider-rewritten prompt, when the image API returns one. */
  revisedPrompt?: string;
  /** Same-session image attachments submitted to the edit endpoint. */
...
export interface MessageAttachment {
  ...
  storagePath: string;
  /** Present only for assets generated by generate_image. */
...
export interface DocumentVersionMeta {
  ...
  undone?: boolean;
  /** Terminal prose review snapshot for this exact version body, when available. */
  qualityReport?: ProseQualityReport;
}
